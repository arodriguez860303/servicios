<div class="row">
	<div class="col-md-6">
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('nombre', null, ['id'=>'nombre', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>				
		...
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('ap_paterno', null, ['id'=>'ap_paterno', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>				
		...
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('ap_materno', null, ['id'=>'ap_materno', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>				
		...
		<div class="form-group row  m-b-15">
			...
			<div class="col-md-9">
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="sexo" id="sexo_1" value="1" <?php echo e($chk_sexo_1); ?>>
					<label class="form-check-label" for="sexo_1">Masculino</label>
				</div>
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="sexo" id="sexo_2" value="2" <?php echo e($chk_sexo_2); ?>>
	...
	<div class="col-md-6">
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('curp', null, ['id'=>'curp', 'placeholder'=>'',  'class'=>'form-control m-b-5', 'oninput'=>"validarCurp(this)", 'maxlength'=>18]); ?>
		...
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('rfc', null, ['id'=>'rfc', 'placeholder'=>'',  'class'=>'form-control m-b-5', 'maxlength'=>13]); ?>
		...
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('telefono', null, ['id'=>'telefono', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>
		...
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('correo', null, ['id'=>'correo', 'placeholder'=>'',  'class'=>'form-control m-b-5', 'oninput'=>"validarCorreo(this)"]); ?>
...
<div class="row">
	<div class="col-md-6">
		...
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('calle', null, ['id'=>'calle', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>
		...
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('entre_calle', null, ['id'=>'entre_calle', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>
		...
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('y_calle', null, ['id'=>'y_calle', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>
	...
	<div class="col-md-6">
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('num_exterior', null, ['id'=>'num_exterior', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>
		...
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('num_interior', null, ['id'=>'num_interior', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>
		...
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('colonia', null, ['id'=>'colonia', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>
		...
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('codigo_postal', null, ['id'=>'codigo_postal', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::text('nickname', null, ['id'=>'nickname', 'placeholder'=>'',  'class'=>'form-control m-b-5']); ?>				
...
<div class="row">
	...
	<div class="col-md-6">
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::password('password', ['id'=>'password', 'placeholder'=>'',  'class'=>'form-control m-b-5', 'data-toggle'=>'password', 'data-placement'=>'after']); ?>				
	...
	<div class="col-md-6">
		<div class="form-group row m-b-15">
			...
			<div class="col-md-9">
				<?php echo Form::password('password_confirmation', ['id'=>'password_confirmation', 'placeholder'=>'',  'class'=>'form-control m-b-5', 'data-toggle'=>'password', 'data-placement'=>'after']); ?>				
...
<div class="form-group row m-b-0">
	...
	<div class="col-md-12 col-sm-12 text-right">
		...
		<?php echo Form::button('Crear cuenta', ['class' => 'btn btn-primary', 'type' => 'button', 'data-uk-tooltip'=>'{pos:bottom}', 'title'=>'Guardar', 'onclick'=>'save(this);']); ?>

	</div>
</div><?php /**PATH D:\laragon\www\salud\dipris\resources\views/frontend/crear-cuenta/form.blade.php ENDPATH**/ ?>