                ...
                <div class="modal-body">
                    ...
                    <form id="frmRecuperarPass" name="frmRecuperarPass" class="frmRecuperarPass">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="txtRfc" name="txtRfc" class="form-control m-b-5"  />
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\tramites_dipris\c-dipris\resources\views/auth/login.blade.php ENDPATH**/ ?>