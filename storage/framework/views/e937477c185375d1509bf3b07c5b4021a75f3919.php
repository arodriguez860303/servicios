  ...
  <div class="content">
    ...
    <div class="container">
     <div class="mb-4"  style="text-align:center">
      ...
      <a class="btn text-white btn-block" href="crear-cuenta/registro" role="button" style="background:#333333; width:250px; margin:auto; text-decoration: none;">Crea tu cuenta</a>
    </div>
    <hr class="lineaD">		
    <div style="text-align:center">
      <br><span class="ml-auto" style="color:#818285">Dirección de Protección contra Riesgos Sanitarios<br>Teléfono (961) 611 1185 <br> fomento.dipris@salud.chiapas.gob.mx</span><br>
      <!--img src="<?php echo e(asset('lgDipris/images/salud.png')); ?>" alt="Image" class="img-fluid"-->
    </div>
  </div>
</div>
    ...
    <script type="text/javascript">
      //var vuri = window.location.origin + '/dipris'; 
...
</html><?php /**PATH D:\laragon\www\tramites_dipris\c-dipris\resources\views/layouts/login.blade.php ENDPATH**/ ?>