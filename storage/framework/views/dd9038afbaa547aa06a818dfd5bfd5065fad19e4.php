    		...
    		<div class="block-content bg-body-light">
    			<div class="note note-secondary m-b-15">
					<div class="note-content">
						<?php echo Form::hidden('anio', date('Y'),['id'=>'anio']); ?>
						...
						<p>
							A continuación se muestran las estadisticas de las <b>solicitudes</b> realizados en el año actual <b><?php echo e(date('Y')); ?></b>. En caso de necesitar mas información seleccione el año correspondiente. 
						</p>
					</div>
				</div>
    		</div>
...
</div><?php /**PATH D:\laragon\www\salud\dipris\resources\views/dashboard/head_anio.blade.php ENDPATH**/ ?>