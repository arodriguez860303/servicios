        ...
        success: function(vresponse, vtextStatus, vjqXHR) {
            ...
            if ( parseInt(vresponse.codigo) == 1 ) {
                ...
                for ( vi=0; vi < vrespuesta.length; vi++ ) {
                    ...
                    var _folio = ""; var _fin = "";
                    if(vrespuesta[vi].folio != null && vrespuesta[vi].folio != '')  _folio = vrespuesta[vi].folio; else _folio = '-----';
                    if(vrespuesta[vi].fecha_fin != null && vrespuesta[vi].fecha_fin != '')  _fin = vrespuesta[vi].fecha_fin; else _fin = '-----';
                ...
                vhtml+='            <td class="fs-sm">' + vrespuesta[vi].folio_hacienda + '</td>';
                ...
                vhtml+='                    <a onclick="confirmDelete(' + vrespuesta[vi].id + ')"  class="btn btn-sm btn-alt-secondary" data-bs-toggle="tooltip" title="Ver">';
...
function confirmDelete(id_tramite)
{  
   Swal.fire({
        title: "¿ Esta seguro de eliminar este trámite ?",
...
function eliminar(id_tramite)
{
    $.ajax({
        type: 'POST',
        url: vuri + '/admin/tramites/eliminar', 
        headers: {
