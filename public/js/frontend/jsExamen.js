...
function store_(inputObject, vnumPregunta, vrespuesta)
{
    if( validar_pregunta(inputObject, vnumPregunta, vrespuesta) ) {
        $.ajax({
            type: 'POST',
            url: vuri + '/mis-tramites/examen/responder',
            dataType: "JSON",
...
function calificacion()
{
    $.ajax({
        type: 'GET',
        url: vuri + '/mis-tramites/examen/datos',
        dataType: "JSON",
        success: function(vresponse, vtextStatus, vjqXHR) {
            var vrespuesta=vresponse;           
            var vhtml = '';

            if(vrespuesta.datos_constancia.folio_hacienda != null && 
...
function store_nuevo_examen()
{
    $.ajax({
            type: 'POST',
            url: vuri + '/mis-tramites/examen/nueva-evaluacion',
            headers: {
