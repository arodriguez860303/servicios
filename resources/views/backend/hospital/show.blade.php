...
@section('descripcion')
  Detalles del tramite de diploma de un Hospital
@endsection
...
@section('buttons') 
	...
	<a class="btn btn-outline-secondary" href="{{ route('tramites-hospital.'.$ruta) }}"><i class="fa fa-fw fa-arrow-rotate-left"></i> Regresar</a>
@endsection
...
@section('content')
	...
	@include('backend.hospital.tabGral')
	@include('backend.hospital.modal_observacion')
@endsection

@section('js')
 	<script src="{{ asset('backend/validate.js') }}"></script>
 	<script src="{{ asset('backend/hospital/jsShow.js') }}"></script> 
@endsection
